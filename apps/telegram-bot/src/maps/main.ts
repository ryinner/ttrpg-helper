...
const paladin = new Character('paladin', 'Паладин', [
  {
    name: 'Характер',
    description:
      '*Черты характера*:\n\nВы крайне осторожны, всегда в ожидании монстров и других опасностей.\n\n*Идеалы*:\n\nНадежда. Вы проживёте жизнь приключений и соберёте множество историй.\n\n*Привязанности*:\n\nВы никогда не причините вред тому, кто слабее или менее удачлив чем вы.\n\n*Слабости*:\n\nВы не любите пропускать трапезу, и становитесь угрюмым и сварливым, когда приходится.\n\n',
  },
  {
    name: 'Везучий',
    description:
...
const monk = new Character('monk', 'Монах', [
  {
    name: 'Характер',
    description:
      '*Черта характера*:\n\nМеня раздражает, если люди хвалят кого-то другого, а не меня.*Идеалы*:\n\nСоревнования. Я стремлюсь проверять себя во всем.\n\n*Привязанность*:\n\n Моя ошибка причинила боль кому-то. Я больше никогда не совершу эту ошибку.\n\n*Слабость*:\n\nЯ должен быть капитаном любой группы, к которой присоединяюсь.',
  },
  {
    name: 'Крепкий',
    description:
...
const sorcerer = new Character('sorcerer', 'Чародей', [
  {
    name: 'Характер',
    description:
      'Черты характера:\n\nЯ ... говорю ... медленно ... когда разговариваю ... с идиотами, ... то есть ... практически ... всегда.\n\nИдеал:\n\nЛогика. Эмоции не должны подавлять логическое мышление.\n\nПривязанность:\n\nВсю свою жизнь я ищу ответ на один вопрос.\n\nСлабость:\n\nЯ говорю, не обдумывая слова, чем часто оскорбляю других.',
  },
  {
    name: 'Сопротивление урону (Огонь)',
    description: 'Урон от огня уменьшен вдвое',
  },
  {
    name: 'Оружие дракона',
    description: '15 футовый конус (спас. ТЕЛ). 2д6 урона, при спасе половина.',
  },
  {
    name: 'Исследователь',
    description:
  ...
  {
    name: 'Круг 2: Земляная хватка Максимилиана',
    description:
